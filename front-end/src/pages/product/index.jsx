    ...
    <section id="product">
      <div className="product__content">
        <div className="product__content__top d-flex mb-5">
          ...
          <div className="product__content__top__product-infomation">
            ...
            <div className="d-flex text-center mb-5">
              ...
              <Button className="type-02 body-large w-100">ADD TO CART</Button>
            </div>
        ...
        <div className="product__content__similar-items-list">
          ...
          <div className="product__content__similar-items-list__item row row-cols-3">
            <div>
              <ProductStyle
                className="body-large"
                src={IMG_PRODUCT_03}
