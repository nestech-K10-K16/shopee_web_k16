          ...
          <div className="home__content display-flex-flex-direction-column">
            ...
            <div className="home__content__product">
              ...
              <div className="home__content__product__row-1 display-flex margin-bottom-4rem">
                ...
                <div>
                  <img src={IMG_04} alt="" />
                  <p className="heading-03 margin-bottom-0-5rem">Kaede Hair Pin Set Of 3 </p>
              ...
              <div className="home__content__product__row-2 display-flex">
                <div className="margin-right-2rem">
                  <img src={IMG_05} alt="" />
                  <p className="heading-03 margin-bottom-0-5rem">Hair Pin Set of 3</p>
                  <p className="heading-04">$ 30,00</p>
                </div>

                <div className="margin-right-2rem">
                  <img src={IMG_06} alt="" />
                  <p className="heading-03 margin-bottom-0-5rem">Plaine Necklace</p>
                  <p className="heading-04">$ 19,00</p>
                </div>

                <div>
                  <img src={IMG_07} alt="" />
                  <p className="heading-03 margin-bottom-0-5rem">Yuki Hair Pin Set of 3</p>
